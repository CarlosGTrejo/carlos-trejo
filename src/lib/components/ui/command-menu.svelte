...
<p class="text-muted-foreground text-sm max-lg:hidden">
    Press
    <kbd
        class="bg-muted text-muted-foreground pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border px-1 font-mono text-xs font-medium"
    >
        {key}
    </kbd>

    <kbd
        class="bg-muted text-muted-foreground pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border px-1.5 font-mono text-xs font-medium"
    >
        K
    </kbd>
    to search
